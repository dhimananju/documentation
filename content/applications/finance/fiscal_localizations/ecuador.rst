...
.. list-table::
   ...
   * - :guilabel:`Ecuadorian ATS Report`
     - `l10n_ec_reports_ats`
     - Includes all the technical and functional requirements to generate ATS report XML file ready
       to be uploaded to the *DIMM Formularios*.
